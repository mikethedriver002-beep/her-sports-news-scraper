...
- `europe_top_flight/teams.csv` includes current WSL, Liga F, Frauen-Bundesliga, and Serie A Women club source rows; remaining European team and athlete expansion remains manual and review-only.
