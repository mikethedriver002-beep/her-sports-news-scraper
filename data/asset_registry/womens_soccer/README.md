...
- `europe_top_flight/teams.csv` includes current WSL, Liga F, and Frauen-Bundesliga club source rows; remaining European team and athlete expansion remains manual and review-only.
