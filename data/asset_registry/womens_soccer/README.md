...
- `europe_top_flight/teams.csv` includes current WSL and Liga F club source rows; remaining European team and athlete expansion remains manual and review-only.
