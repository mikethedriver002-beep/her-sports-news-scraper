...
def breaking_public_signal_board_rows() -> List[Dict[str, str]]:
    ...
    for index, row in enumerate(read_csv("breaking_public_signal_queue.csv")[:8], 1):
        ...
        item = {
            ...
            "next_action": short(
                "Open breaking_public_signal_confirmation_intake.csv and record the official, wire, primary, or operator-verified check.",
                180,
            ),
            ...
            "promotion_target": "breaking_public_signal_confirmation_intake.csv",
