...
MIRRORED_REVIEW_ARTIFACTS = [
    ...
    "data/asset_registry/womens_soccer/womens_soccer_action_photo_first_paste_guide.md",
    ...
    "data/asset_registry/action_photo_candidates/review_only_action_photo_manual_first_action_cards_v1.md",
    "data/asset_registry/action_photo_candidates/review_only_action_photo_manual_first_action_cards_v1.csv",
    "data/asset_registry/action_photo_candidates/review_only_action_photo_manual_first_action_cards_v1.json",
...
ARTIFACTS = [
    ...
    ("Graphics", "Women's soccer action-photo first paste guide", "data/asset_registry/womens_soccer/womens_soccer_action_photo_first_paste_guide.md"),
    ("Graphics", "Women's soccer action-photo first paste guide data", "data/asset_registry/womens_soccer/womens_soccer_action_photo_first_paste_guide.csv"),
    ("Graphics", "Women's soccer action-photo first paste guide manifest", "data/asset_registry/womens_soccer/womens_soccer_action_photo_first_paste_guide.json"),
    ...
    ("Graphics", "Action-photo manual first-action cards", "data/asset_registry/action_photo_candidates/review_only_action_photo_manual_first_action_cards_v1.md"),
    ("Graphics", "Action-photo manual first-action cards data", "data/asset_registry/action_photo_candidates/review_only_action_photo_manual_first_action_cards_v1.csv"),
    ("Graphics", "Action-photo manual first-action cards manifest", "data/asset_registry/action_photo_candidates/review_only_action_photo_manual_first_action_cards_v1.json"),
...
RUN_COMMANDS = {
    ...
    "data/asset_registry/womens_soccer/womens_soccer_action_photo_first_paste_guide.md": ".\\.venv\\Scripts\\python.exe scripts\\generate_hsd_womens_soccer_athlete_verification_queue_v1.py",
    "data/asset_registry/womens_soccer/womens_soccer_action_photo_first_paste_guide.csv": ".\\.venv\\Scripts\\python.exe scripts\\generate_hsd_womens_soccer_athlete_verification_queue_v1.py",
    "data/asset_registry/womens_soccer/womens_soccer_action_photo_first_paste_guide.json": ".\\.venv\\Scripts\\python.exe scripts\\generate_hsd_womens_soccer_athlete_verification_queue_v1.py",
    ...
    "data/asset_registry/action_photo_candidates/review_only_action_photo_manual_first_action_cards_v1.md": ".\\.venv\\Scripts\\python.exe scripts\\report_hsd_action_photo_manual_research_bridge_v1.py",
    "data/asset_registry/action_photo_candidates/review_only_action_photo_manual_first_action_cards_v1.csv": ".\\.venv\\Scripts\\python.exe scripts\\report_hsd_action_photo_manual_research_bridge_v1.py",
    "data/asset_registry/action_photo_candidates/review_only_action_photo_manual_first_action_cards_v1.json": ".\\.venv\\Scripts\\python.exe scripts\\report_hsd_action_photo_manual_research_bridge_v1.py",
...
def asset_availability_readiness_panel() -> Dict[str, Any]:
    ...
    womens_soccer_action_photo_first_paste_manifest = read_json("data/asset_registry/womens_soccer/womens_soccer_action_photo_first_paste_guide.json")
    womens_soccer_action_photo_first_paste_rows_data = read_csv("data/asset_registry/womens_soccer/womens_soccer_action_photo_first_paste_guide.csv")
    ...
    womens_soccer_action_photo_first_paste_rows = as_int(womens_soccer_action_photo_first_paste_manifest.get("first_paste_rows")) if isinstance(womens_soccer_action_photo_first_paste_manifest, dict) else len(womens_soccer_action_photo_first_paste_rows_data)
    womens_soccer_action_photo_first_paste_cue = packet_freshness_cue(
        "data/asset_registry/womens_soccer/womens_soccer_action_photo_first_paste_guide.md",
        womens_soccer_action_photo_first_paste_rows,
        RUN_COMMANDS["data/asset_registry/womens_soccer/womens_soccer_action_photo_first_paste_guide.md"],
        context="women's soccer action-photo first paste guide",
    )
    ...
    action_photo_research_return_import_review_rows = as_int(action_photo_research_return_import_review_manifest.get("import_review_rows")) if isinstance(action_photo_research_return_import_review_manifest, dict) else 0
    action_photo_research_return_import_review_cue = packet_freshness_cue(
        "data/asset_registry/action_photo_candidates/review_only_action_photo_research_return_import_review_v1.md",
    ...
    action_photo_manual_research_bridge_cue = packet_freshness_cue(
        "data/asset_registry/action_photo_candidates/review_only_action_photo_manual_research_bridge_v1.md",
        action_photo_manual_research_bridge_rows,
        RUN_COMMANDS["data/asset_registry/action_photo_candidates/review_only_action_photo_manual_research_bridge_v1.md"],
        context="action-photo manual research bridge",
    )
    action_photo_manual_first_action_cards_rows = as_int(action_photo_manual_first_action_cards_manifest.get("first_action_cards")) if isinstance(action_photo_manual_first_action_cards_manifest, dict) else 0
    action_photo_manual_first_action_cards_cue = packet_freshness_cue(
        "data/asset_registry/action_photo_candidates/review_only_action_photo_manual_first_action_cards_v1.md",
        action_photo_manual_first_action_cards_rows,
        RUN_COMMANDS["data/asset_registry/action_photo_candidates/review_only_action_photo_manual_first_action_cards_v1.md"],
        context="action-photo manual first-action cards",
    )
    action_photo_manual_return_evidence_checklist_rows = as_int(action_photo_manual_return_evidence_checklist_manifest.get("checklist_rows")) if isinstance(action_photo_manual_return_evidence_checklist_manifest, dict) else 0
    action_photo_manual_return_evidence_checklist_cue = packet_freshness_cue(
        "data/asset_registry/action_photo_candidates/review_only_action_photo_manual_return_evidence_checklist_v1.md",
    ...
    hockey_softball_action_photo_first_paste_rows = as_int(hockey_softball_action_photo_first_paste_manifest.get("rows")) if isinstance(hockey_softball_action_photo_first_paste_manifest, dict) else 0
    hockey_softball_action_photo_first_paste_cue = packet_freshness_cue(
        "data/asset_registry/hockey_softball_action_photo_first_paste_guide.md",
    ...
    return {
        ...
        "womens_soccer_action_photo_first_paste_status": clean(womens_soccer_action_photo_first_paste_manifest.get("status")) if isinstance(womens_soccer_action_photo_first_paste_manifest, dict) else "",
        "womens_soccer_action_photo_first_paste_rows": womens_soccer_action_photo_first_paste_rows,
        "womens_soccer_action_photo_first_paste_generated_ready_rows": as_int(womens_soccer_action_photo_first_paste_manifest.get("generated_ready_rows")) if isinstance(womens_soccer_action_photo_first_paste_manifest, dict) else 0,
        "womens_soccer_action_photo_first_paste_generated_download_approval_rows": as_int(womens_soccer_action_photo_first_paste_manifest.get("generated_download_approval_rows")) if isinstance(womens_soccer_action_photo_first_paste_manifest, dict) else 0,
        "womens_soccer_action_photo_first_paste_blank_source_url_rows": as_int(womens_soccer_action_photo_first_paste_manifest.get("blank_source_url_rows")) if isinstance(womens_soccer_action_photo_first_paste_manifest, dict) else sum(1 for row in womens_soccer_action_photo_first_paste_rows_data if not clean(row.get("source_url"))),
        "womens_soccer_action_photo_first_paste_generated_at": clean(womens_soccer_action_photo_first_paste_manifest.get("generated_at_utc")) if isinstance(womens_soccer_action_photo_first_paste_manifest, dict) else "",
        "womens_soccer_action_photo_first_paste_asset_downloads": bool(womens_soccer_action_photo_first_paste_manifest.get("asset_downloads")) if isinstance(womens_soccer_action_photo_first_paste_manifest, dict) else False,
        "womens_soccer_action_photo_first_paste_headshot_writes": bool(womens_soccer_action_photo_first_paste_manifest.get("headshot_writes")) if isinstance(womens_soccer_action_photo_first_paste_manifest, dict) else False,
        "womens_soccer_action_photo_first_paste_approved_marker_writes": bool(womens_soccer_action_photo_first_paste_manifest.get("approved_marker_writes")) if isinstance(womens_soccer_action_photo_first_paste_manifest, dict) else False,
        "womens_soccer_action_photo_first_paste_freshness_status": womens_soccer_action_photo_first_paste_cue["status"],
        "womens_soccer_action_photo_first_paste_freshness_detail": womens_soccer_action_photo_first_paste_cue["detail"],
        "womens_soccer_action_photo_first_paste_refresh_command": womens_soccer_action_photo_first_paste_cue["run_command"],
        ...
        "action_photo_research_return_import_review_status": clean(action_photo_research_return_import_review_manifest.get("status")) if isinstance(action_photo_research_return_import_review_manifest, dict) else "",
        "action_photo_research_return_import_review_generated_at": clean(action_photo_research_return_import_review_manifest.get("generated_at_utc")) if isinstance(action_photo_research_return_import_review_manifest, dict) else "",
        "action_photo_research_return_import_review_rows": action_photo_research_return_import_review_rows,
        "action_photo_research_return_import_review_rows_with_data": as_int(action_photo_research_return_import_review_manifest.get("rows_with_research_return_data")) if isinstance(action_photo_research_return_import_review_manifest, dict) else 0,
        "action_photo_research_return_import_review_ready_rows": as_int(action_photo_research_return_import_review_manifest.get("ready_for_later_human_download_decision_review_rows")) if isinstance(action_photo_research_return_import_review_manifest, dict) else 0,
        "action_photo_research_return_import_review_human_download_yes_rows": as_int(action_photo_research_return_import_review_manifest.get("human_intake_download_approved_yes_rows")) if isinstance(action_photo_research_return_import_review_manifest, dict) else 0,
        "action_photo_research_return_import_review_generated_download_yes_rows": as_int(action_photo_research_return_import_review_manifest.get("generated_download_approved_yes_rows")) if isinstance(action_photo_research_return_import_review_manifest, dict) else 0,
        "action_photo_research_return_import_review_blank_source_url_rows": as_int(action_photo_research_return_import_review_manifest.get("blank_source_url_rows")) if isinstance(action_photo_research_return_import_review_manifest, dict) else 0,
        "action_photo_research_return_import_review_blank_rights_class_rows": as_int(action_photo_research_return_import_review_manifest.get("blank_rights_class_rows")) if isinstance(action_photo_research_return_import_review_manifest, dict) else 0,
        "action_photo_research_return_import_review_source_fetching": bool(action_photo_research_return_import_review_manifest.get("source_fetching")) if isinstance(action_photo_research_return_import_review_manifest, dict) else False,
        "action_photo_research_return_import_review_auto_source_enablement": bool(action_photo_research_return_import_review_manifest.get("auto_source_enablement")) if isinstance(action_photo_research_return_import_review_manifest, dict) else False,
        ...
        "action_photo_manual_research_bridge_source_rows": as_int(action_photo_manual_research_bridge_manifest.get("source_rows")) if isinstance(action_photo_manual_research_bridge_manifest, dict) else 0,
        "action_photo_manual_research_bridge_womens_soccer_source_rows": as_int(action_photo_manual_research_bridge_manifest.get("womens_soccer_source_rows")) if isinstance(action_photo_manual_research_bridge_manifest, dict) else 0,
        "action_photo_manual_research_bridge_hockey_softball_source_rows": as_int(action_photo_manual_research_bridge_manifest.get("hockey_softball_source_rows")) if isinstance(action_photo_manual_research_bridge_manifest, dict) else 0,
        "action_photo_manual_research_bridge_import_rows_with_data": as_int(action_photo_manual_research_bridge_manifest.get("shared_import_rows_with_data")) if isinstance(action_photo_manual_research_bridge_manifest, dict) else 0,
        "action_photo_manual_research_bridge_ready_rows": as_int(action_photo_manual_research_bridge_manifest.get("candidate_ready_for_later_human_download_decision_review_rows")) if isinstance(action_photo_manual_research_bridge_manifest, dict) else 0,
        "action_photo_manual_research_bridge_generated_download_approval_rows": as_int(action_photo_manual_research_bridge_manifest.get("generated_download_approval_rows")) if isinstance(action_photo_manual_research_bridge_manifest, dict) else 0,
        "action_photo_manual_research_bridge_source_fetching": bool(action_photo_manual_research_bridge_manifest.get("source_fetching")) if isinstance(action_photo_manual_research_bridge_manifest, dict) else False,
        "action_photo_manual_research_bridge_auto_source_enablement": bool(action_photo_manual_research_bridge_manifest.get("auto_source_enablement")) if isinstance(action_photo_manual_research_bridge_manifest, dict) else False,
        "action_photo_manual_research_bridge_asset_downloads": bool(action_photo_manual_research_bridge_manifest.get("asset_downloads")) if isinstance(action_photo_manual_research_bridge_manifest, dict) else False,
        "action_photo_manual_research_bridge_headshot_writes": bool(action_photo_manual_research_bridge_manifest.get("headshot_writes")) if isinstance(action_photo_manual_research_bridge_manifest, dict) else False,
        "action_photo_manual_research_bridge_approved_marker_writes": bool(action_photo_manual_research_bridge_manifest.get("approved_marker_writes")) if isinstance(action_photo_manual_research_bridge_manifest, dict) else False,
        "action_photo_manual_first_action_cards_status": clean(action_photo_manual_first_action_cards_manifest.get("status")) if isinstance(action_photo_manual_first_action_cards_manifest, dict) else "",
        "action_photo_manual_first_action_cards_generated_at": clean(action_photo_manual_first_action_cards_manifest.get("generated_at_utc")) if isinstance(action_photo_manual_first_action_cards_manifest, dict) else "",
        "action_photo_manual_first_action_cards_rows": action_photo_manual_first_action_cards_rows,
        "action_photo_manual_first_action_cards_generated_download_approval_rows": as_int(action_photo_manual_first_action_cards_manifest.get("generated_download_approval_rows")) if isinstance(action_photo_manual_first_action_cards_manifest, dict) else 0,
        "action_photo_manual_first_action_cards_source_fetching": bool(action_photo_manual_first_action_cards_manifest.get("source_fetching")) if isinstance(action_photo_manual_first_action_cards_manifest, dict) else False,
        "action_photo_manual_first_action_cards_auto_source_enablement": bool(action_photo_manual_first_action_cards_manifest.get("auto_source_enablement")) if isinstance(action_photo_manual_first_action_cards_manifest, dict) else False,
        "action_photo_manual_first_action_cards_asset_downloads": bool(action_photo_manual_first_action_cards_manifest.get("asset_downloads")) if isinstance(action_photo_manual_first_action_cards_manifest, dict) else False,
        "action_photo_manual_first_action_cards_headshot_writes": bool(action_photo_manual_first_action_cards_manifest.get("headshot_writes")) if isinstance(action_photo_manual_first_action_cards_manifest, dict) else False,
        "action_photo_manual_first_action_cards_approved_marker_writes": bool(action_photo_manual_first_action_cards_manifest.get("approved_marker_writes")) if isinstance(action_photo_manual_first_action_cards_manifest, dict) else False,
        "action_photo_manual_return_evidence_checklist_status": clean(action_photo_manual_return_evidence_checklist_manifest.get("status")) if isinstance(action_photo_manual_return_evidence_checklist_manifest, dict) else "",
        "action_photo_manual_return_evidence_checklist_generated_at": clean(action_photo_manual_return_evidence_checklist_manifest.get("generated_at_utc")) if isinstance(action_photo_manual_return_evidence_checklist_manifest, dict) else "",
        "action_photo_manual_return_evidence_checklist_rows": action_photo_manual_return_evidence_checklist_rows,
        "action_photo_manual_return_evidence_checklist_generated_ready_rows": as_int(action_photo_manual_return_evidence_checklist_manifest.get("generated_ready_rows")) if isinstance(action_photo_manual_return_evidence_checklist_manifest, dict) else 0,
        "action_photo_manual_return_evidence_checklist_generated_download_approval_rows": as_int(action_photo_manual_return_evidence_checklist_manifest.get("generated_download_approval_rows")) if isinstance(action_photo_manual_return_evidence_checklist_manifest, dict) else 0,
        "action_photo_manual_return_evidence_checklist_source_fetching": bool(action_photo_manual_return_evidence_checklist_manifest.get("source_fetching")) if isinstance(action_photo_manual_return_evidence_checklist_manifest, dict) else False,
        "action_photo_manual_return_evidence_checklist_auto_source_enablement": bool(action_photo_manual_return_evidence_checklist_manifest.get("auto_source_enablement")) if isinstance(action_photo_manual_return_evidence_checklist_manifest, dict) else False,
        ...
        "action_photo_manual_first_action_cards_freshness_status": action_photo_manual_first_action_cards_cue["status"],
        "action_photo_manual_first_action_cards_freshness_detail": action_photo_manual_first_action_cards_cue["detail"],
        "action_photo_manual_first_action_cards_refresh_command": action_photo_manual_first_action_cards_cue["run_command"],
        ...
        "hockey_softball_action_photo_first_paste_status": clean(hockey_softball_action_photo_first_paste_manifest.get("status")) if isinstance(hockey_softball_action_photo_first_paste_manifest, dict) else "",
        "hockey_softball_action_photo_first_paste_generated_at": clean(hockey_softball_action_photo_first_paste_manifest.get("generated_at_utc")) if isinstance(hockey_softball_action_photo_first_paste_manifest, dict) else "",
        "hockey_softball_action_photo_first_paste_rows": hockey_softball_action_photo_first_paste_rows,
        "hockey_softball_action_photo_first_paste_womens_hockey_rows": as_int(hockey_softball_action_photo_first_paste_manifest.get("womens_hockey_rows")) if isinstance(hockey_softball_action_photo_first_paste_manifest, dict) else 0,
        "hockey_softball_action_photo_first_paste_softball_rows": as_int(hockey_softball_action_photo_first_paste_manifest.get("softball_rows")) if isinstance(hockey_softball_action_photo_first_paste_manifest, dict) else 0,
        "hockey_softball_action_photo_first_paste_generated_download_approval_rows": as_int(hockey_softball_action_photo_first_paste_manifest.get("generated_download_approval_rows")) if isinstance(hockey_softball_action_photo_first_paste_manifest, dict) else 0,
        "hockey_softball_action_photo_first_paste_generated_ready_rows": as_int(hockey_softball_action_photo_first_paste_manifest.get("generated_ready_rows")) if isinstance(hockey_softball_action_photo_first_paste_manifest, dict) else 0,
        "hockey_softball_action_photo_first_paste_blank_source_url_rows": as_int(hockey_softball_action_photo_first_paste_manifest.get("blank_source_url_rows")) if isinstance(hockey_softball_action_photo_first_paste_manifest, dict) else 0,
        ...
        "file_shortcuts": [
            ...
            file_shortcut("Women's soccer action-photo first paste guide", "data/asset_registry/womens_soccer/womens_soccer_action_photo_first_paste_guide.md", "Top women's soccer action-photo rows to paste first, with evidence fields and no-download guardrails."),
            file_shortcut("Women's soccer action-photo first paste guide data", "data/asset_registry/womens_soccer/womens_soccer_action_photo_first_paste_guide.csv", "Machine-readable first-paste rows with blank/no generated defaults and shared return-intake target."),
            file_shortcut("Women's soccer action-photo first paste guide manifest", "data/asset_registry/womens_soccer/womens_soccer_action_photo_first_paste_guide.json", "Counts and guardrails for the women's soccer action-photo first-paste guide."),
            ...
            file_shortcut("Action-photo manual first-action cards", "data/asset_registry/action_photo_candidates/review_only_action_photo_manual_first_action_cards_v1.md", "Two review-only cards with exact source row, paste target, fields to fill, evidence cues, and rerun command; no downloads."),
            file_shortcut("Action-photo manual first-action cards data", "data/asset_registry/action_photo_candidates/review_only_action_photo_manual_first_action_cards_v1.csv", "Machine-readable first-action cards; generated approval and write fields remain no or false."),
            file_shortcut("Action-photo manual first-action cards manifest", "data/asset_registry/action_photo_candidates/review_only_action_photo_manual_first_action_cards_v1.json", "Counts and guardrails for the action-photo manual first-action cards."),
...
def release_readiness_evidence_panel() -> Dict[str, Any]:
    ...
    workflow_missing_durable_lanes = as_int(workflow.get("missing_durable_lane_count"))
    if blocker_count:
    ...
    elif workflow_missing_durable_lanes:
        next_step = "Recover missing durable lane thread references, then rerun the conductor visibility review."
    else:
    ...
    return {
        ...
        "workflow_missing_durable_lanes": workflow_missing_durable_lanes,
      ...
      <div class="asset-readiness-desk">
        <div class="decision-cockpit-card asset-readiness-cockpit">
          ...
          <div class="decision-status-grid">
            ...
            <div><span>Soccer first paste</span><strong>{html.escape(str(panel.get('womens_soccer_action_photo_first_paste_rows', 0)))}</strong></div>
            <div><span>Soccer paste ready/dl</span><strong>{html.escape(str(panel.get('womens_soccer_action_photo_first_paste_generated_ready_rows', 0)))}/{html.escape(str(panel.get('womens_soccer_action_photo_first_paste_generated_download_approval_rows', 0)))}</strong></div>
            <div><span>Soccer paste writes</span><strong>{html.escape(str(panel.get('womens_soccer_action_photo_first_paste_asset_downloads', False)).lower())}/{html.escape(str(panel.get('womens_soccer_action_photo_first_paste_headshot_writes', False)).lower())}/{html.escape(str(panel.get('womens_soccer_action_photo_first_paste_approved_marker_writes', False)).lower())}</strong></div>
            ...
            <div><span>Import review rows</span><strong>{html.escape(str(panel.get('action_photo_research_return_import_review_rows', 0)))}</strong></div>
            <div><span>Import rows with data</span><strong>{html.escape(str(panel.get('action_photo_research_return_import_review_rows_with_data', 0)))}</strong></div>
            ...
            <div><span>Bridge ready review</span><strong>{html.escape(str(panel.get('action_photo_manual_research_bridge_ready_rows', 0)))}</strong></div>
            <div><span>Bridge fetch/enable</span><strong>{html.escape(str(panel.get('action_photo_manual_research_bridge_source_fetching', False)).lower())}/{html.escape(str(panel.get('action_photo_manual_research_bridge_auto_source_enablement', False)).lower())}</strong></div>
            <div><span>First-action cards</span><strong>{html.escape(str(panel.get('action_photo_manual_first_action_cards_rows', 0)))}</strong></div>
            <div><span>Card generated dl</span><strong>{html.escape(str(panel.get('action_photo_manual_first_action_cards_generated_download_approval_rows', 0)))}</strong></div>
            <div><span>Card fetch/enable</span><strong>{html.escape(str(panel.get('action_photo_manual_first_action_cards_source_fetching', False)).lower())}/{html.escape(str(panel.get('action_photo_manual_first_action_cards_auto_source_enablement', False)).lower())}</strong></div>
          ...
          {packet_freshness_html(panel, 'womens_soccer_action_photo_first_paste', "Women's soccer action-photo first paste guide")}
...
def render_markdown(payload: Dict[str, Any]) -> str:
    ...
    lines += [
        ...
        f"- Women's soccer action-photo first-paste rows: {asset_panel.get('womens_soccer_action_photo_first_paste_rows', 0)}",
        f"- Women's soccer action-photo first-paste generated ready/download approvals: {asset_panel.get('womens_soccer_action_photo_first_paste_generated_ready_rows', 0)}/{asset_panel.get('womens_soccer_action_photo_first_paste_generated_download_approval_rows', 0)}",
        f"- Women's soccer action-photo first-paste blank source_url rows: {asset_panel.get('womens_soccer_action_photo_first_paste_blank_source_url_rows', 0)}",
        f"- Women's soccer action-photo first-paste asset/headshot/marker writes: {asset_panel.get('womens_soccer_action_photo_first_paste_asset_downloads', False)}/{asset_panel.get('womens_soccer_action_photo_first_paste_headshot_writes', False)}/{asset_panel.get('womens_soccer_action_photo_first_paste_approved_marker_writes', False)}",
        f"- Women's soccer action-photo first-paste generated: {asset_panel.get('womens_soccer_action_photo_first_paste_generated_at') or 'missing'}",
        ...
        f"- Action-photo research return import review rows: {asset_panel.get('action_photo_research_return_import_review_rows', 0)}",
        f"- Action-photo research return import review rows with data: {asset_panel.get('action_photo_research_return_import_review_rows_with_data', 0)}",
        f"- Action-photo research return import review ready rows: {asset_panel.get('action_photo_research_return_import_review_ready_rows', 0)}",
        f"- Action-photo research return import review human download-approved yes rows: {asset_panel.get('action_photo_research_return_import_review_human_download_yes_rows', 0)}",
        f"- Action-photo research return import review generated download-approved yes rows: {asset_panel.get('action_photo_research_return_import_review_generated_download_yes_rows', 0)}",
        ...
        f"- Action-photo manual research bridge hockey/softball rows: {asset_panel.get('action_photo_manual_research_bridge_hockey_softball_source_rows', 0)}",
        f"- Action-photo manual research bridge import rows with data: {asset_panel.get('action_photo_manual_research_bridge_import_rows_with_data', 0)}",
        f"- Action-photo manual research bridge ready rows: {asset_panel.get('action_photo_manual_research_bridge_ready_rows', 0)}",
        f"- Action-photo manual research bridge generated download approvals: {asset_panel.get('action_photo_manual_research_bridge_generated_download_approval_rows', 0)}",
        f"- Action-photo manual research bridge source-fetching/auto-source-enable: {asset_panel.get('action_photo_manual_research_bridge_source_fetching', False)}/{asset_panel.get('action_photo_manual_research_bridge_auto_source_enablement', False)}",
        f"- Action-photo manual research bridge asset/headshot/marker writes: {asset_panel.get('action_photo_manual_research_bridge_asset_downloads', False)}/{asset_panel.get('action_photo_manual_research_bridge_headshot_writes', False)}/{asset_panel.get('action_photo_manual_research_bridge_approved_marker_writes', False)}",
        f"- Action-photo manual research bridge generated: {asset_panel.get('action_photo_manual_research_bridge_generated_at') or 'missing'}",
        f"- Action-photo manual first-action card rows: {asset_panel.get('action_photo_manual_first_action_cards_rows', 0)}",
        f"- Action-photo manual first-action card generated download approvals: {asset_panel.get('action_photo_manual_first_action_cards_generated_download_approval_rows', 0)}",
        f"- Action-photo manual first-action card source-fetching/auto-source-enable: {asset_panel.get('action_photo_manual_first_action_cards_source_fetching', False)}/{asset_panel.get('action_photo_manual_first_action_cards_auto_source_enablement', False)}",
        f"- Action-photo manual first-action card asset/headshot/marker writes: {asset_panel.get('action_photo_manual_first_action_cards_asset_downloads', False)}/{asset_panel.get('action_photo_manual_first_action_cards_headshot_writes', False)}/{asset_panel.get('action_photo_manual_first_action_cards_approved_marker_writes', False)}",
        f"- Action-photo manual first-action cards generated: {asset_panel.get('action_photo_manual_first_action_cards_generated_at') or 'missing'}",
        f"- Action-photo manual return evidence checklist rows: {asset_panel.get('action_photo_manual_return_evidence_checklist_rows', 0)}",
        f"- Action-photo manual return evidence checklist generated ready/download approvals: {asset_panel.get('action_photo_manual_return_evidence_checklist_generated_ready_rows', 0)}/{asset_panel.get('action_photo_manual_return_evidence_checklist_generated_download_approval_rows', 0)}",
        ...
        f"- Hockey/softball action-photo first-paste rows: {asset_panel.get('hockey_softball_action_photo_first_paste_rows', 0)}",
        f"- Hockey/softball action-photo first-paste generated ready/download approvals: {asset_panel.get('hockey_softball_action_photo_first_paste_generated_ready_rows', 0)}/{asset_panel.get('hockey_softball_action_photo_first_paste_generated_download_approval_rows', 0)}",
        ...
        packet_freshness_markdown(
            {
                "status": asset_panel.get("womens_soccer_action_photo_first_paste_freshness_status"),
                "detail": asset_panel.get("womens_soccer_action_photo_first_paste_freshness_detail"),
                "run_command": asset_panel.get("womens_soccer_action_photo_first_paste_refresh_command"),
            },
        ...
        packet_freshness_markdown(
            {
                "status": asset_panel.get("action_photo_research_return_import_review_freshness_status"),
                "detail": asset_panel.get("action_photo_research_return_import_review_freshness_detail"),
        ...
        packet_freshness_markdown(
            {
                "status": asset_panel.get("action_photo_manual_research_bridge_freshness_status"),
                "detail": asset_panel.get("action_photo_manual_research_bridge_freshness_detail"),
                "run_command": asset_panel.get("action_photo_manual_research_bridge_refresh_command"),
            },
            "Action-photo manual research bridge",
        ),
        packet_freshness_markdown(
            {
                "status": asset_panel.get("action_photo_manual_first_action_cards_freshness_status"),
                "detail": asset_panel.get("action_photo_manual_first_action_cards_freshness_detail"),
                "run_command": asset_panel.get("action_photo_manual_first_action_cards_refresh_command"),
            },
            "Action-photo manual first-action cards",
        ),
        packet_freshness_markdown(
            {
                "status": asset_panel.get("action_photo_manual_return_evidence_checklist_freshness_status"),
                "detail": asset_panel.get("action_photo_manual_return_evidence_checklist_freshness_detail"),
        ...
        packet_freshness_markdown(
            {
                "status": asset_panel.get("hockey_softball_action_photo_first_paste_freshness_status"),
                "detail": asset_panel.get("hockey_softball_action_photo_first_paste_freshness_detail"),
