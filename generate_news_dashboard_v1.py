...
<title>Her Sports Daily News Sync v1.4</title>
<style>
:root {{
...
<body>
<header><div class="wrap brand"><div class="bug">HER<br>SPORTS<br>DAILY</div><div><h1>News Sync v1.4</h1><div class="sub">Generated {esc(datetime.now(timezone.utc).isoformat())}. Source-backed news packets on top of Results Desk. v1.4 uses CSV-primary enrichment, winner-first score copy, and cleaner top performers.</div></div></div></header>
<main>
