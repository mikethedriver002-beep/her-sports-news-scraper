...
def build_intake_row(paths: Dict[str, Path | None], qa_manifest: Dict[str, Any], checklist_rows: List[Dict[str, str]]) -> Dict[str, str]:
    ...
    return {
        ...
        "operator_name": "",
        "reviewed_at_local": "",
        "required_evidence": "Open draft_preview.png plus manual_visual_qa_report.md; confirm readable text, the single draft watermark, source-safe copy, crop safety, and any checklist holds.",
