...
Packet ID: `ig-stories_ig-stories-rolling-1_last-night-in-the-w`
Platform: `IG Stories`
League: `WNBA`
...
Last Night in the W | WNBA | result_or_recap | Last Night in the W: put this result on the board. | Last Night in the W The result matters because it changes the conversation, not just the scoreboard. | RESULT CHECK: Last Night in the W What changed after this one? | What was the swing moment? | v3.3.6-mermaid-assignment-handoff-v2.6 | ig_stories_rolling_1 |…
