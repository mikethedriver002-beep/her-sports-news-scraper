...
Last Night in the W. • Final scores are in. Dallas made people look twice. Minnesota made a statement. Two finals, two very different kinds of pressure, and one night that gave us more than a box score. Which result mattered most? 🏀 #HerSportsDaily #WomensSports #WNBA #Basketball

Manual prompt dossier:
# HSD Manual Prompt Dossier — Last Night in the W

Packet: `ig-stories_ig-stories-rolling-2_last-night-in-the-w`
Platform: `IG Stories`
...
Last Night in the W | WNBA | result_or_recap | Last Night in the W: put this result on the board. | Last Night in the W The result matters because it changes the conversation, not just the scoreboard. | RESULT CHECK: Last Night in the W What changed after this one? | What was the swing moment? | v3.3.6-mermaid-assignment-handoff-v2.6 | ig_stories_rolling_2 | IG Stories | 12:30 PM | result_or_recap | Last Night in the W | WNBA | P1 | story_aaf82414d4dbab | ready_with_review | ready_with_review | 78 | supporting_story_card_two | fresh | Last Night in the W: put this result on the board. | Last Night in the W Biggest takeaway? | Last Night in the W The result matters because it changes the conversation, not just the scoreboard. | RESULT CHECK: Last Night in the W What changed after this one? 
