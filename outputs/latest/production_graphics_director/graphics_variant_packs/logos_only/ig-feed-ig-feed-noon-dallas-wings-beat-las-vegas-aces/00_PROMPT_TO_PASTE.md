...
Detected teams: dallas_wings;las_vegas_aces
...
Dallas Wings beat Las Vegas Aces. Final: Dallas Wings 96, Las Vegas Aces 66. Dallas did more than win. The Wings put a number on the board that makes the whole night feel different, and Vegas leaves with questions that will carry into the next one. That is the kind of result that deserves more than a score graphic. What did this one tell you? 🏀 #HerSportsDaily #WomensSports #WNBA #Basketball #DallasWings #LasVegasAces

Manual prompt dossier:
# HSD Manual Prompt Dossier — Dallas Wings beat Las Vegas Aces

Packet: `ig-feed_ig-feed-noon_dallas-wings-beat-las-vegas-aces`
Platform: `IG Feed`
...
Dallas Wings beat Las Vegas Aces | WNBA | result_or_recap | Dallas Wings beat Las Vegas Aces: put this result on the board. | Dallas Wings beat Las Vegas Aces The result matters because it changes the conversation, not just the scoreboard. | RESULT CHECK: Dallas Wings beat Las Vegas Aces What changed after this one? | What was the swing moment? | v3.3.6-mermaid-assignment-handoff-v2.6 | ig_feed_noon | IG Feed | 12:00 PM | result_or_recap | Dallas Wings beat Las Vegas Aces | WNBA | P1 | story_d5d97578488db3 | ready_with_review | score_assets_needed | 78 | strongest_feed_assignment | fresh | crosspost_story_d5d97578488db3 | Dallas Wings beat Las Vegas Aces: put this result on the board. | Dallas Wings beat Las Vegas Aces Biggest takeaway? | Dallas Wings beat Las Vegas Aces The result matters
