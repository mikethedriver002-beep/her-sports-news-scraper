...
- Recompute the near-post-ready flag after Phase 6L public-copy metadata is
  written. The prior Phase 6L wrapper rewrote the Story metadata correctly but
  preserved a stale Story near-post-ready=false value from the intermediate item.
"""
...
PHASE6L_EFFECTIVE_VERSION = "v4.7-phase6l-editorial-language-polish-hotfix2"
