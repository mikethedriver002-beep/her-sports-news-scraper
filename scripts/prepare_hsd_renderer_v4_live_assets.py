...
VERSION = "v1.2-phase6l-decodable-live-asset-preparation-nonfatal-missing-active"
...
def build_report(root: Path) -> Dict[str, Any]:
    ...
    try:
        ...
        report = {
            ...
            "rows": details,
            "free_only": True,
            "notes": "Phase 6L requires every approved exact logo to be image-decodable. Missing active logos are reported, but not globally fatal; renderer/live gates must prevent any row using a missing logo from becoming a live candidate.",
        }
        return report
    finally:
        import os
