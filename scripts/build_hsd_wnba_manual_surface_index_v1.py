...
SURFACES = [
    ...
    SurfaceSpec(
        ...
        priority="P3_storm_manual_source_check",
    ...
    SurfaceSpec(
        ...
        priority="P5_visual_hold_unless_selected",
...
def build_report(manifest: dict[str, Any], rows: list[dict[str, str]]) -> str:
    ...
    lines.extend(
        [
            ...
            "## Blunt Read",
            "",
            "- Use the Fever visual-rank board first.",
