    ...
    return textwrap.dedent(
        ...
        def add_scene_blocks(spec: dict[str, object]) -> None:
            ...
            if mode == "score_command":
                add_box("BottomScoreBand", (0.0, -2.62, 0.02), (2.45, 0.11, 0.03), accent)
                add_box("LeftAccent", (-2.58, 2.35, 0.02), (0.05, 0.48, 0.03), accent)
                add_text("Headline", str(spec["headline"]), (-2.42, 2.55, 0.12), 0.42, (0.96, 0.97, 0.99, 1.0), True, "LEFT")
                add_text("Subhead", str(spec["subhead"]), (-2.42, 2.12, 0.12), 0.17, accent, True, "LEFT")
                add_text("Body", str(spec["body"]), (-2.42, 1.84, 0.12), 0.12, (0.86, 0.90, 0.96, 1.0), False, "LEFT")
            else:
                add_box("BottomBand", (0.0, -2.60, 0.02), (2.25, 0.11, 0.03), (0.05, 0.06, 0.08, 1.0))
                add_box("TopRule", (-1.52, 2.78, 0.02), (1.0, 0.035, 0.03), accent)
                add_text("Headline", str(spec["headline"]), (-2.42, 2.42, 0.12), 0.30, (0.96, 0.97, 0.99, 1.0), True, "LEFT")
                add_text("Subhead", str(spec["subhead"]), (-2.42, 2.10, 0.12), 0.15, accent, True, "LEFT")
                add_text("Body", str(spec["body"]), (-2.42, 1.82, 0.12), 0.11, (0.86, 0.90, 0.96, 1.0), False, "LEFT")
