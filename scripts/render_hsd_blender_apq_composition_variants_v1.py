...
VARIANT_SPECS: list[dict[str, Any]] = [
    {
        ...
        "photo_title": {"line_1": "PHOTO ANCHOR", "line_2": "APQ001", "location": [0.8, 0.14, 1.8], "size": 0.36, "line_gap": 0.28},
        "score_block": {"line_1": "OPEN SCORE", "line_2": "0 - 0", "location": [0.8, 0.12, 0.54], "size": 0.48, "line_gap": 0.26},
        "support_lines": [
            {"text": "OPEN HIERARCHY", "location": [0.8, 0.12, -0.04], "size": 0.1, "color": [228, 233, 245]},
            {"text": "SOFT SCRIM", "location": [0.8, 0.12, -0.28], "size": 0.085, "color": [168, 176, 191]},
        ],
        ...
        "editorial_scrim": {"location": (2.5, 0.12, 0.98), "scale": (1.96, 4.1, 1.0), "alpha": 0.28},
        ...
        "photo_anchor_scrim_treatment_mode": "soft_editorial_scrim_v2",
    ...
    },
    {
        ...
        "photo_plane_offset": 0.004,
        "photo_title": {"line_1": "SCORE DRAMA", "line_2": "APQ001", "location": [0.46, 0.12, 1.76], "size": 0.26, "line_gap": 0.24},
        "score_block": {"line_1": "FINAL", "line_2": "0 - 0", "location": [0.46, 0.12, 0.84], "size": 0.58, "line_gap": 0.24},
        "support_lines": [
            {"text": "PHOTOGRAPHY STILL VISIBLE", "location": [0.46, 0.12, 0.08], "size": 0.09, "color": [194, 200, 215]},
            {"text": "NO DASHBOARD BOXES", "location": [0.46, 0.12, -0.16], "size": 0.075, "color": [160, 166, 180]},
        ],
        "use_score_plate": False,
        "use_editorial_scrim": True,
        "source_photo_crop_mode": "fit_1080x1350_right_focus",
        ...
        "photo_texture_render_layer_mode": "texture_front_no_frame_cover",
        "composition_treatment_mode": "score_forward_open_editorial",
        "editorial_scrim": {"location": (3.0, 0.12, 0.98), "scale": (0.9, 4.1, 1.0), "alpha": 0.16},
        "burn_in": {"location": (0.98, -0.2, -2.08), "size": 0.08, "align_x": "CENTER"},
        "burn_in_position_mode": "bottom_safe_footer_tag",
        "burn_in_treatment_mode": "bottom_safe_footer_tag",
        "score_typography_treatment": "score_drama_open_type",
        "layout_polish_checks": {
            "burn_in_inside_canvas": True,
            "burn_in_off_primary_body": True,
            "frame_clutter_reduced": True,
    ...
    },
    {
        ...
        "photo_plane_scale": 1.02,
        "photo_plane_offset": 0.004,
        "photo_title": {"line_1": "CLEAN EDITORIAL", "line_2": "APQ001", "location": [0.52, 0.12, 1.76], "size": 0.24, "line_gap": 0.24},
        "score_block": {"line_1": "0 - 0", "line_2": "MAGAZINE TREATMENT", "location": [0.5, 0.12, 0.9], "size": 0.26, "line_gap": 0.22},
        "support_lines": [
            {"text": "MORE NEGATIVE SPACE", "location": [0.52, 0.12, 0.16], "size": 0.08, "color": [198, 205, 217]},
            {"text": "LIGHTER STAT TEXT", "location": [0.52, 0.12, -0.1], "size": 0.07, "color": [150, 157, 171]},
        ],
        "use_score_plate": False,
        "use_editorial_scrim": True,
        "source_photo_crop_mode": "fit_1080x1350_right_focus",
        ...
        "editorial_scrim": {"location": (3.08, 0.12, 0.98), "scale": (0.76, 4.1, 1.0), "alpha": 0.12},
        "burn_in": {"location": (1.08, -0.2, -2.08), "size": 0.08, "align_x": "CENTER"},
        "burn_in_position_mode": "bottom_safe_footer_tag",
        "burn_in_treatment_mode": "bottom_safe_footer_tag",
        "score_typography_treatment": "open_editorial_type",
...
def resolve_quarantine_image_path(scene_payload: dict[str, Any]) -> Path:
    ...
    if candidate.is_absolute() and resolved.exists() and "review_only_candidates" in resolved.parts:
        return resolved
    if not candidate.is_absolute():
        candidate = repo_root() / candidate
        resolved = candidate.resolve(strict=False)
    if resolved.exists() and "review_only_candidates" in resolved.parts:
        return resolved
        ...
        specs.append(
            {
                **base,
                ...
                "burn_in_treatment_mode": str(base.get("burn_in_treatment_mode") or "bottom_safe_footer_tag"),
        ...
        rows.append(
            {
                ...
                "burn_in_legibility": "",
                "burn_in_treatment_mode": str(spec.get("burn_in_treatment_mode") or ""),
                ...
                "score_typography_treatment": str(spec.get("score_typography_treatment") or ""),
                "composition_treatment_mode": str(spec.get("composition_treatment_mode") or ""),
