...
VERSION = "hsd-wnba-official-source-expansion-highres-v11-review-only"
GENERATED_BY = "scripts/build_hsd_wnba_official_source_expansion_highres_v11.py"
...
def build_packet(
    *,
    ...
    manifest = {
        ...
        "status": "wnba_official_source_expansion_highres_v11_ready" if intake_rows else "wnba_official_source_expansion_highres_v11_empty",
        "review_only": True,
