...
def expected_specs(source_root: Path, screenshot_dir: Path) -> list[AttachmentSpec]:
    return [
        ...
        AttachmentSpec(
            surface_id="purdue_wsoc_v7_focus_deck",
            surface_name="Purdue women's soccer v7 focused deck",
            source_kind="focused_deck_html",
            source_path=source_root / "action_photo_review_deck_official_source_expansion_v7" / "action_photo_review_deck.html",
            attachment_name="purdue_wsoc_v7_focus_deck_screenshot.png",
            attachment_source_kind="browser_screenshot",
            screenshot_source_name="purdue_wsoc_v7_focus_deck.png",
            attachment_note="Browser screenshot of the current Purdue women's soccer review deck.",
        ),
        AttachmentSpec(
...
def build_report(manifest: dict[str, Any], rows: list[dict[str, str]], missing_sources: list[str]) -> str:
    lines = [
        ...
        "4. Purdue women's soccer v7 focused deck screenshot",
        "5. World Rugby v5 focused deck screenshot",
        "6. Latest broad deck screenshot",
        "",
        "## Attachment Index",
        "",
