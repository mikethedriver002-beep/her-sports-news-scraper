...
$GeneratedStatePathspecs = @(
    ...
    "render_next_level_editorial_qa.*",
    "manual_visual_qa_*",
    "adobe_visual_qa_packet/**",
    "adobe_visual_qa_result_*",
    "adobe_visual_qa_revision_requests.csv",
    "adobe_visual_qa_renderer_revision_plan.*",
    "adobe_visual_qa_renderer_revision_spec.*",
...
function Invoke-AssetAuditStage($Python) {
    ...
    Invoke-ScriptIfPresent $Python "scripts\generate_hsd_wnba_logo_contact_sheet_v1.py" -Optional
    if ($env:HSD_RUN_OUTPUT_DIR) {
        ...
        foreach ($relative in @(
            ...
            "data/asset_registry/wnba/wnba_team_logo_contact_sheet.png",
            "data/asset_registry/wnba/wnba_team_logo_review_intake.csv",
...
function Invoke-RenderStage($Python) {
    ...
    Invoke-ScriptIfPresent $Python "generate_hsd_manual_visual_qa_operator_decision_template_v1.py" -Optional
...
function Collect-HsdArtifacts($RunContext) {
    ...
    $reviewFiles = @(
        ...
        "game_source_confirmation_return_summary_v1.md",
        "game_source_confirmation_return_summary_v1.csv",
        "game_source_confirmation_return_summary_v1.json",
        ...
        "breaking_public_signal_clusters.md",
        ...
        "workflow_durable_lane_recovery_packet.md",
        "workflow_durable_lane_recovery_packet.csv",
        "workflow_durable_lane_recovery_packet.json",
        ...
        "render_prep_packets.csv",
        "render_prep_packets.json",
        ...
        "manual_visual_qa_operator_decision_template.md",
        "manual_visual_qa_operator_decision_template.csv",
        "manual_visual_qa_operator_decision_template.json",
