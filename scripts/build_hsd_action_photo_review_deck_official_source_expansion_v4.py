...
VERSION = "hsd-action-photo-review-deck-official-source-expansion-v4-review-only"
DEFAULT_OFFICIAL_EXPANSION_CSV = Path(
    "outputs/local/latest/files/action_photo_official_source_expansion_v4/action_photo_candidate_intake.csv"
)
DEFAULT_OUTPUT_DIR = Path("outputs/local/tmp/action_photo_review_deck_official_source_expansion_v4")
DEFAULT_LIMIT = 36
...
def main(argv: list[str] | None = None) -> int:
    ...
    manifest["source_packet"] = "action_photo_official_source_expansion_v4"
