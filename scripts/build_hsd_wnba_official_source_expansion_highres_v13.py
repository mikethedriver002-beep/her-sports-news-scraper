...
VERSION = "hsd-wnba-official-source-expansion-highres-v13-review-only"
GENERATED_BY = "scripts/build_hsd_wnba_official_source_expansion_highres_v13.py"
...
DEFAULT_OUTPUT_DIR = REPO_ROOT / "outputs" / "local" / "tmp" / "wnba_official_source_expansion_highres_v13"
DEFAULT_LATEST_OUTPUT_DIR = REPO_ROOT / "outputs" / "local" / "latest" / "files" / "wnba_official_source_expansion_highres_v13"
DEFAULT_USER_AGENT = (
        ...
        board_rows.append(
            {
                ...
                "source_family_id": "wnba_official_2019_all_star_photo_suite",
                "candidate_queue_id": candidate_id,
...
def render_report(manifest: dict[str, Any]) -> str:
    ...
    lines = [
        "# WNBA Official Source Expansion Highres V13",
        "",
        f"Generated: `{manifest['generated_at_utc']}`",
        "",
        "Review-only metadata-first source scout for the official WNBA 2019 All-Star photo-suite lane.",
        "",
        "## Summary",
        "",
...
def build_packet(
    *,
    ...
    seed_path = output_dir / "wnba_official_source_expansion_highres_v13_seed.csv"
    intake_path = output_dir / "wnba_official_source_expansion_highres_v13_intake.csv"
    board_path = output_dir / "wnba_official_source_expansion_highres_v13_board.csv"
    report_path = output_dir / "wnba_official_source_expansion_highres_v13_report.md"
    ...
    manifest: dict[str, Any] = {
        ...
        "status": "wnba_official_source_expansion_highres_v13_ready" if intake_rows else "wnba_official_source_expansion_highres_v13_empty",
        "review_only": True,
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build the WNBA 2019 All-Star official photo-suite source scout packet.")
