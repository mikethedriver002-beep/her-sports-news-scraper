"""
Her Sports Daily Women's Sports News Scraper v11 Final
-----------------------------------------------

FINAL LOCKED VERSION. This version rebuilds the editorial decision logic around one core rule:
...
RESULT_TERMS = [
    ...
    "score", "title defense", "clinches", "clinch", "clinched", "wins series", "won series",
    "claims series", "claim series", "sweeps", "sweep", "beats", "defeats",
]
...
def classify_story_type(text: str) -> str:
    ...
    # Order matters. These prevent false positives like "first round" or "shatter myth."
    ...
    # Business/money terms beat record words like "record-breaking purse."
