...
VERSION = "hsd-install-verifier-v3.2.13-bebe-ops-v2.11"
EXPECTED_PIPELINE_VERSION = "v3.2.13-bebe-ops-v2.11"
...
OPTIONAL_TEMPLATE_FILES = [
    ...
    "operator/inbox/manual_workflow_inbox_template_v1.csv",
...
STALE_FILES = [
    ...
    "manual_workflow_priority_report.md", "manual_workflow_pack_status.csv", "manual_workflow_pack_status.json",
...
STALE_DIRS = [
    ...
    "manual_workflow_packets", "manual_workflow_handoff_packs",
...
def main() -> None:
    ...
    if review_gen.exists():
        ...
        if "manual_workflow_handoff_packs" not in rt:
            warnings.append("lite review generator does not include Manual Workflow handoff pack ZIPs")
    ...
    if not issues:
        lines.append("Install verification passed for safe execution. Version/display mismatches are warnings, not blockers, in BeBe Ops v2.11.")
