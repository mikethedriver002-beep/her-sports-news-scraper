...
KEY_FILES = [
    ...
    "final_score_stat_proof_v1.csv", "final_score_stat_proof_v1.md", "final_score_stat_proof_v1.json",
    ...
    "launch_instagram_publish_queue.csv", "launch_caption_drafts.md", "launch_story_plan.md",
    "launch_quality_gate.csv", "launch_daily_operator_checklist.md", "launch_post_publish_tracker.csv",
    "launch_metrics_manual_input.csv", "launch_7_day_performance_dashboard.md", "launch_what_to_double_down_on.md",
    "launch_manifest.json", "launch_dashboard/index.html", "launch_analytics_dashboard/index.html",
    ...
    "source_registry_proposal_promotion_checklist.md", "source_registry_proposal_promotion_checklist.csv",
    "source_registry_update_worksheet.md", "source_registry_update_worksheet.csv",
    ...
    "source_registry_post_edit_validation.md", "source_registry_post_edit_validation.csv",
    ...
    "nwsl_source_proposal_pack.md", "nwsl_source_proposal_pack.csv",
    "lpga_source_proposal_pack.md", "lpga_source_proposal_pack.csv",
    ...
    "render_prep_packets.md", "render_prep_packets.csv", "render_prep_packets.json",
    "render_handoff_top_packet/README.md", "render_handoff_top_packet/copy_sheet.md", "render_handoff_top_packet/copy_sheet.csv",
    "render_handoff_top_packet/asset_checklist.md", "render_handoff_top_packet/asset_checklist.csv",
    "render_handoff_top_packet/source_proof.md", "render_handoff_top_packet/manual_renderer_prompt.md",
