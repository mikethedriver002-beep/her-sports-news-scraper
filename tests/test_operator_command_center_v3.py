...
def test_command_center_links_breaking_public_signal_artifacts() -> None:
    ...
    assert "breaking_public_signal_confirmation_intake.md" in artifact_paths
    ...
    assert "game_fact_confirmation_status_v1.md" in artifact_paths
    assert "game_fact_confirmation_status_v1.csv" in artifact_paths
    assert "game_fact_confirmation_status_v1.json" in artifact_paths
...
def test_command_center_links_and_mirrors_action_photo_artifacts(tmp_path, monkeypatch) -> None:
    ...
    quarantine_preflight_command = ".\\.venv\\Scripts\\python.exe scripts\\report_hsd_action_photo_quarantine_preflight_v1.py"
    quarantine_preflight_paths = {
    ...
    for path in quarantine_preflight_paths:
        assert path in artifact_paths
        assert path in mirrored_paths
        assert command_center.RUN_COMMANDS[path] == quarantine_preflight_command
    ...
    external_review_command = ".\\.venv\\Scripts\\python.exe scripts\\report_hsd_action_photo_external_research_return_review_v1.py"
    ...
    for path in external_review_paths:
        assert path in artifact_paths
        assert path in mirrored_paths
        assert command_center.RUN_COMMANDS[path] == external_review_command
...
def test_command_center_surfaces_breaking_public_signal_as_review_only_source_board(tmp_path, monkeypatch) -> None:
    ...
    assert row["promotion_target"] == "breaking_public_signal_clusters.csv"
    assert "breaking_public_signal_clusters.md" in row["next_action"]
    assert "confirmation_intake.csv" in row["next_action"]
...
def test_command_center_surfaces_cluster_confirmation_evidence_cues(tmp_path, monkeypatch) -> None:
        ...
        [
            {
                ...
                "public_signal_type": "no_public_signal_captured",
                "public_signal_confidence": "none",
                "public_signal_count": "0",
                "public_signal_limitations_cue": "No public/community signal captured; do not infer public reaction or use social context as confirmation.",
                "confirmation_gap": "Current artifacts provide a review cue only; operator must still verify the cited source URL, final/result facts, and recency in the confirmation intake.",
    ...
    assert "public_signal_type=no_public_signal_captured" in row["story_opportunity_source_coverage"]
...
def test_asset_readiness_panel_surfaces_womens_soccer_logo_contact_sheet(tmp_path, monkeypatch) -> None:
    ...
    Path("data/asset_registry/womens_soccer/womens_soccer_athlete_photo_download_intake.md").write_text("# Download intake\n", encoding="utf-8")
    write_csv_with_fields(
        ...
        [
            {
                ...
                "display_name": "operator_add_player_candidate",
                "candidate_id": "angel_city_fc_operator_add_candidate",
                "entity_id": "angel_city_fc_operator_add_candidate",
                ...
                "proposed_quarantine_path": "data/assets/quarantine/review_only_candidates/womens_soccer/athlete_photo_candidates/nwsl/angel_city_fc/operator_fill_required/angel_city_fc_operator_add_candidate.png",
                "download_approved": "no",
                "download_status": "not_requested",
                "operator_source_url": "operator_fill_required",
                "operator_rights_class": "operator_fill_required",
                "operator_identity_confidence": "operator_fill_required",
                "operator_intended_review_only_use": "operator_fill_required",
                "operator_notes": "",
                "reviewed_by": "",
                "reviewed_at_local": "",
    ...
    Path("data/asset_registry/womens_soccer/womens_soccer_athlete_verification_queue.md").write_text("# Verification queue\n", encoding="utf-8")
    write_csv_with_fields(
        "data/asset_registry/womens_soccer/womens_soccer_athlete_verification_queue.csv",
        [
            {
                "queue_rank": "1",
                "queue_bucket": "p0_nwsl_roster_verification_first",
                "scope_id": "nwsl",
                "league_id": "nwsl",
                "team_id": "angel_city_fc",
                "team_name": "Angel City FC",
                "candidate_rows": "2",
                "missing_local_candidate_rows": "2",
                "gray_area_rows": "0",
            ...
            {
                "queue_rank": "2",
                "queue_bucket": "p1_europe_gray_area_source_review",
                "scope_id": "europe_top_flight",
                "league_id": "wsl_england",
                "team_id": "all_teams",
                "team_name": "WSL England",
                "candidate_rows": "1",
                "missing_local_candidate_rows": "1",
                "gray_area_rows": "1",
    ...
    write_json(
        "data/asset_registry/womens_soccer/womens_soccer_athlete_verification_queue.json",
        {
            ...
            "generated_at_utc": "2026-06-27T21:00:00+00:00",
            "queue_rows": 2,
            "nwsl_team_rows": 1,
            "europe_league_rows": 1,
            "p0_nwsl_roster_verification_rows": 1,
            "gray_area_rows": 1,
            "missing_local_candidate_rows": 3,
            "download_approved_yes_rows": 0,
            "review_only": True,
            "approval_state_change": False,
            "candidate_state_change": False,
    ...
    Path("data/asset_registry/womens_soccer/womens_soccer_athlete_source_priority.md").write_text("# Source priority\n", encoding="utf-8")
    write_csv_with_fields(
        "data/asset_registry/womens_soccer/womens_soccer_athlete_source_priority.csv",
        [
            {
                "source_priority_rank": "1",
                "source_review_bucket": "1_nwsl_p0_roster_source_check",
                "scope_id": "nwsl",
                "league_id": "nwsl",
                "team_id": "angel_city_fc",
                "team_name": "Angel City FC",
                ...
                "download_approved": "no",
                "source_url": "",
                "candidate_entity_id": "angel_city_fc",
                "entity_id": "",
                "rights_class": "",
                "identity_confidence": "",
                "intended_review_only_use": "",
            ...
            },
            {
                ...
                "source_review_bucket": "2_gray_area_or_reputable_manual_verify",
                "scope_id": "europe_top_flight",
                "league_id": "wsl_england",
                "team_id": "chelsea_women",
                "team_name": "Chelsea Women",
                "operator_verify_required": "yes",
                "source_candidate_url": "https://example.org/chelsea",
                "download_approved": "no",
                "source_url": "",
                "candidate_entity_id": "chelsea_women",
                "entity_id": "",
                "rights_class": "",
                "identity_confidence": "",
                "intended_review_only_use": "",
    ...
    write_json(
        "data/asset_registry/womens_soccer/womens_soccer_athlete_source_priority.json",
        {
            ...
            "generated_at_utc": "2026-06-27T21:20:00+00:00",
            "source_priority_rows": 2,
            "nwsl_source_rows": 1,
            "europe_source_rows": 1,
            "operator_verify_required_rows": 2,
            "gray_or_reputable_manual_verify_rows": 1,
            "download_approved_yes_rows": 0,
            "blank_source_url_rows": 2,
            "review_only": True,
            "approval_state_change": False,
    ...
    Path("data/asset_registry/womens_soccer/womens_soccer_athlete_review_triage.md").write_text("# Review triage\n", encoding="utf-8")
    write_csv_with_fields(
        "data/asset_registry/womens_soccer/womens_soccer_athlete_review_triage.csv",
        [
            {
                "triage_rank": "1",
                "primary_manual_action": "official_roster_check",
                "scope_id": "nwsl",
                "league_id": "nwsl",
                "team_id": "angel_city_fc",
                "team_name": "Angel City FC",
            ...
            {
                "triage_rank": "2",
                "primary_manual_action": "gray_area_reputable_lead_review",
                "scope_id": "europe_top_flight",
                "league_id": "wsl_england",
                "team_id": "all_teams",
                "team_name": "WSL England",
                "download_approved": "no",
                "source_url": "",
                "candidate_entity_id": "wsl_england",
                "entity_id": "",
                "rights_class": "",
                "identity_confidence": "",
                "intended_review_only_use": "",
    ...
    write_json(
        "data/asset_registry/womens_soccer/womens_soccer_athlete_review_triage.json",
        {
            ...
            "generated_at_utc": "2026-06-27T21:30:00+00:00",
            "triage_rows": 2,
            "nwsl_rows": 1,
            "europe_rows": 1,
            "download_approved_yes_rows": 0,
    ...
    Path("data/asset_registry/womens_soccer/womens_soccer_athlete_candidate_next_action_board.md").write_text(
    ...
    write_json(
        "data/asset_registry/womens_soccer/womens_soccer_athlete_candidate_next_action_board.json",
        {
            ...
            "generated_at_utc": "2026-06-27T21:40:00+00:00",
    ...
    write_csv_with_fields(
        ...
        [
            {
                "closure_rank": "1",
                "artifact_group": "operator_focus",
                "artifact_label": "Open first",
                "artifact_path": "data/asset_registry/womens_soccer/womens_soccer_athlete_operator_focus.md",
                "row_count": "2",
                "nwsl_rows": "1",
                "europe_rows": "1",
                "p0_or_verify_rows": "2",
                ...
                "blank_source_url_rows": "2",
                "download_approved_yes_rows": "0",
                "local_candidate_gap_rows": "0",
                "manual_next_action": "Open focus rows first.",
                "operator_open_after": "data/asset_registry/womens_soccer/womens_soccer_athlete_source_priority.csv",
    ...
    write_json(
        "data/asset_registry/womens_soccer/womens_soccer_athlete_expansion_closure_summary.json",
        {
            ...
            "generated_at_utc": "2026-06-27T22:10:00+00:00",
            "closure_summary_rows": 1,
            "total_referenced_rows": 2,
            "p0_or_verify_rows": 2,
            "gray_area_rows": 1,
            "blank_source_url_rows": 2,
            "download_approved_yes_rows": 0,
    ...
    assert panel["womens_soccer_athlete_download_intake_rows"] == 1
    assert panel["womens_soccer_athlete_download_approved_yes_rows"] == 0
    ...
    assert panel["womens_soccer_athlete_verification_queue_status"] == "athlete_verification_queue_ready"
    assert panel["womens_soccer_athlete_verification_queue_rows"] == 2
    assert panel["womens_soccer_athlete_verification_queue_nwsl_rows"] == 1
    assert panel["womens_soccer_athlete_verification_queue_europe_rows"] == 1
    assert panel["womens_soccer_athlete_verification_queue_p0_nwsl_rows"] == 1
    assert panel["womens_soccer_athlete_verification_queue_gray_area_rows"] == 1
    ...
    assert panel["womens_soccer_athlete_source_priority_status"] == "athlete_source_priority_ready"
    assert panel["womens_soccer_athlete_source_priority_rows"] == 2
    assert panel["womens_soccer_athlete_source_priority_nwsl_rows"] == 1
    assert panel["womens_soccer_athlete_source_priority_europe_rows"] == 1
    assert panel["womens_soccer_athlete_source_priority_verify_rows"] == 2
    assert panel["womens_soccer_athlete_source_priority_gray_rows"] == 1
    assert panel["womens_soccer_athlete_source_priority_download_approved_yes_rows"] == 0
    assert panel["womens_soccer_athlete_source_priority_blank_source_url_rows"] == 2
    assert panel["womens_soccer_athlete_source_priority_generated_at"] == "2026-06-27T21:20:00+00:00"
    assert panel["womens_soccer_athlete_source_priority_freshness_status"] == "packet_ready"
    assert panel["womens_soccer_athlete_review_triage_status"] == "athlete_review_triage_ready"
    assert panel["womens_soccer_athlete_review_triage_rows"] == 2
    assert panel["womens_soccer_athlete_review_triage_nwsl_rows"] == 1
    assert panel["womens_soccer_athlete_review_triage_europe_rows"] == 1
    assert panel["womens_soccer_athlete_review_triage_download_approved_yes_rows"] == 0
    assert panel["womens_soccer_athlete_review_triage_blank_source_url_rows"] == 2
    assert panel["womens_soccer_athlete_review_triage_generated_at"] == "2026-06-27T21:30:00+00:00"
    assert panel["womens_soccer_athlete_review_triage_freshness_status"] == "packet_ready"
    assert panel["womens_soccer_athlete_candidate_actions_status"] == "athlete_candidate_next_actions_ready"
    assert panel["womens_soccer_athlete_candidate_actions_rows"] == 2
    assert panel["womens_soccer_athlete_candidate_actions_nwsl_rows"] == 1
    assert panel["womens_soccer_athlete_candidate_actions_europe_rows"] == 1
    assert panel["womens_soccer_athlete_candidate_actions_download_approved_yes_rows"] == 0
    ...
    assert panel["womens_soccer_athlete_closure_p0_or_verify_rows"] == 2
    assert panel["womens_soccer_athlete_closure_gray_area_rows"] == 1
    assert panel["womens_soccer_athlete_closure_download_approved_yes_rows"] == 0
    assert panel["womens_soccer_athlete_closure_blank_source_url_rows"] == 2
    assert panel["womens_soccer_athlete_closure_generated_at"] == "2026-06-27T22:10:00+00:00"
    assert panel["womens_soccer_athlete_closure_freshness_status"] == "packet_ready"
    ...
    assert any(item["label"] == "Women's soccer athlete source priority" for item in panel["file_shortcuts"])
    assert any(item["label"] == "Women's soccer athlete source priority data" for item in panel["file_shortcuts"])
    assert any(item["label"] == "Women's soccer athlete source priority manifest" for item in panel["file_shortcuts"])
    assert any(item["label"] == "Women's soccer athlete review triage" for item in panel["file_shortcuts"])
    assert any(item["label"] == "Women's soccer athlete review triage data" for item in panel["file_shortcuts"])
    assert any(item["label"] == "Women's soccer athlete review triage manifest" for item in panel["file_shortcuts"])
    ...
    assert "Soccer verify queue" in html
    assert "Soccer verify NWSL" in html
    ...
    assert "Soccer source priority" in html
    assert "Soccer source verify" in html
    assert "Soccer source gray" in html
    assert "Soccer triage rows" in html
    assert "Soccer triage NWSL" in html
    assert "Soccer triage blanks" in html
...
def seed_asset_availability_audit_files() -> None:
    ...
    (action_photo_dir / "review_only_action_photo_external_research_return_review_v1.md").write_text("# Action Photo External Research Return Review\n", encoding="utf-8")
    write_csv(
        (action_photo_dir / "review_only_action_photo_external_research_return_review_v1.csv").as_posix(),
        [
            {
                "review_id": "APER001",
                "candidate_queue_id": "APQ001",
    ...
    write_json(
        (action_photo_dir / "review_only_action_photo_external_research_return_review_v1.json").as_posix(),
        {
            ...
            "missing_candidate_queue_ids": ["APQ007", "APQ008"],
    ...
    (action_photo_dir / "review_only_action_photo_manual_first_action_cards_v1.md").write_text("# Action Photo Manual First Action Cards\n", encoding="utf-8")
    write_csv(
        (action_photo_dir / "review_only_action_photo_manual_first_action_cards_v1.csv").as_posix(),
        [
            {
                "card_id": "APFAC01",
                "bridge_lane": "women_soccer_action_photo",
                "manual_priority": "P0_first_manual_return",
                "source_scope": "women's soccer action-photo",
                "download_approved": "no",
                "review_only": "true",
                "source_fetching": "false",
                "auto_source_enablement": "false",
            ...
            },
            {
                ...
                "bridge_lane": "hockey_softball_action_photo",
                "manual_priority": "P0_first_manual_return",
                "source_scope": "hockey/softball action-photo",
                "download_approved": "no",
                "review_only": "true",
                "source_fetching": "false",
                "auto_source_enablement": "false",
    ...
    write_json(
        (action_photo_dir / "review_only_action_photo_manual_first_action_cards_v1.json").as_posix(),
        {
            "status": "action_photo_manual_first_action_cards_ready",
            "generated_at_utc": "2026-06-29T00:02:45+00:00",
            "first_action_cards": 2,
            "generated_download_approval_rows": 0,
            "review_only": True,
            "source_fetching": False,
            "auto_source_enablement": False,
    ...
    (action_photo_dir / "review_only_action_photo_manual_return_evidence_checklist_v1.md").write_text("# Action Photo Manual Return Evidence Checklist\n", encoding="utf-8")
    write_csv(
        (action_photo_dir / "review_only_action_photo_manual_return_evidence_checklist_v1.csv").as_posix(),
        [
            {
    ...
    write_json(
        (action_photo_dir / "review_only_action_photo_manual_return_evidence_checklist_v1.json").as_posix(),
        {
            "status": "action_photo_manual_return_evidence_checklist_ready",
            "generated_at_utc": "2026-06-29T00:02:50+00:00",
            "checklist_rows": 2,
            "generated_ready_rows": 0,
            "generated_download_approval_rows": 0,
            "review_only": True,
    ...
    write_json(
        (action_photo_dir / "review_only_action_photo_candidate_quality_fit_board_v1.json").as_posix(),
        {
            "status": "action_photo_candidate_quality_fit_board_ready",
            "generated_at_utc": "2026-06-29T00:03:30+00:00",
            "quality_fit_rows": 10,
            "source_url_present_rows": 0,
            "rights_class_present_rows": 0,
            "ready_for_human_download_decision_rows": 0,
            "download_approved_yes_rows": 0,
            "validation_issue_count": 0,
            "review_only": True,
...
def seed_manual_visual_qa_decision_files() -> None:
    ...
    write_json(
        "adobe_visual_qa_renderer_revision_plan.json",
        {
            ...
            "review_only": True,
            "plan_rows": 4,
            "spec_status": "adobe_visual_qa_renderer_revision_spec_ready",
            "spec_rows": 4,
            "revision_request_rows": 4,
    ...
    Path("adobe_visual_qa_renderer_revision_spec.md").write_text(
        "# Adobe renderer revision spec\nReview-only implementation checklist.\n",
        encoding="utf-8",
    )
    write_csv_with_fields(
        "adobe_visual_qa_renderer_revision_plan.csv",
    ...
    write_csv_with_fields(
        ...
        [
            ...
            {
                "spec_id": "AVQRS002",
                "source_plan_id": "AVQRP002",
                "priority": "P0",
                "format": "ig_story_9x16",
                "renderer_area": "story_title_safe_zone",
                "implementation_task": "Story safe-zone offset",
                "review_only": "true",
                "asset_downloads": "false",
                "image_edits": "false",
                "renderer_behavior_changed": "false",
            ...
            {
                "spec_id": "AVQRS003",
                "source_plan_id": "AVQRP003",
                "priority": "P0",
                "format": "square_1x1",
                "renderer_area": "square_score_grid",
                "implementation_task": "Square score-grid deboxing",
                "review_only": "true",
                "asset_downloads": "false",
                "image_edits": "false",
                "renderer_behavior_changed": "false",
            ...
            {
                "spec_id": "AVQRS004",
                "source_plan_id": "AVQRP004",
                "priority": "P2",
                "format": "contact_sheet",
                "renderer_area": "contact_sheet_rerender",
                "implementation_task": "Contact-sheet rerender verification",
                "review_only": "true",
                "asset_downloads": "false",
                "image_edits": "false",
                "renderer_behavior_changed": "false",
...
def test_operator_command_center_builds_daily_ops_view(tmp_path, monkeypatch) -> None:
    ...
    assert payload["version"] == command_center.VERSION
    ...
    assert adobe_summary["spec_status"] == "adobe_visual_qa_renderer_revision_spec_ready"
    ...
    assert adobe_summary["spec_rows"] == 4
    ...
    assert "- Renderer spec rows: 4" in markdown
    assert any(
        item["label"] == "Adobe revision spec"
        and item["value"] == "4"
        and item["detail"] == "adobe_visual_qa_renderer_revision_spec_ready"
    ...
    assert payload["asset_readiness_panel"]["action_photo_external_research_return_review_rows"] == 10
    assert payload["asset_readiness_panel"]["action_photo_external_research_return_review_returned_rows"] == 8
    assert payload["asset_readiness_panel"]["action_photo_external_research_return_review_missing_rows"] == 2
    assert payload["asset_readiness_panel"]["action_photo_external_research_return_review_direct_image_hold_rows"] == 8
    assert payload["asset_readiness_panel"]["action_photo_external_research_return_review_identity_vocab_mismatch_rows"] == 8
    assert payload["asset_readiness_panel"]["action_photo_external_research_return_review_ready_rows"] == 0
    assert payload["asset_readiness_panel"]["action_photo_external_research_return_review_generated_download_approval_rows"] == 0
    assert payload["asset_readiness_panel"]["action_photo_external_research_return_review_source_fetching"] is False
    assert payload["asset_readiness_panel"]["action_photo_external_research_return_review_auto_source_enablement"] is False
    assert payload["asset_readiness_panel"]["action_photo_external_research_return_review_asset_downloads"] is False
    assert payload["asset_readiness_panel"]["action_photo_external_research_return_review_headshot_writes"] is False
    assert payload["asset_readiness_panel"]["action_photo_external_research_return_review_approved_marker_writes"] is False
    ...
    assert payload["asset_readiness_panel"]["action_photo_manual_first_action_cards_rows"] == 2
    assert payload["asset_readiness_panel"]["action_photo_manual_first_action_cards_generated_download_approval_rows"] == 0
    assert payload["asset_readiness_panel"]["action_photo_manual_first_action_cards_source_fetching"] is False
    assert payload["asset_readiness_panel"]["action_photo_manual_first_action_cards_auto_source_enablement"] is False
    assert payload["asset_readiness_panel"]["action_photo_manual_first_action_cards_asset_downloads"] is False
    assert payload["asset_readiness_panel"]["action_photo_manual_first_action_cards_headshot_writes"] is False
    assert payload["asset_readiness_panel"]["action_photo_manual_first_action_cards_approved_marker_writes"] is False
    assert payload["asset_readiness_panel"]["action_photo_manual_return_evidence_checklist_rows"] == 2
    assert payload["asset_readiness_panel"]["action_photo_manual_return_evidence_checklist_generated_ready_rows"] == 0
    assert payload["asset_readiness_panel"]["action_photo_manual_return_evidence_checklist_generated_download_approval_rows"] == 0
    assert payload["asset_readiness_panel"]["action_photo_manual_return_evidence_checklist_source_fetching"] is False
    assert payload["asset_readiness_panel"]["action_photo_manual_return_evidence_checklist_auto_source_enablement"] is False
    ...
    assert payload["asset_readiness_panel"]["action_photo_quality_fit_ready_for_human_download_decision_rows"] == 0
    assert payload["asset_readiness_panel"]["action_photo_quality_fit_download_approved_yes_rows"] == 0
    ...
    assert "Action-photo quality/fit board rows: 10" in markdown
    ...
    assert "External return rows" in html
    assert "External missing APQ" in html
    assert "External direct holds" in html
    assert "External identity holds" in html
    assert "External ready/dl" in html
    assert "Action-photo external research return review rows: 10" in markdown
    assert "Action-photo external research return returned/missing rows: 8/2" in markdown
    assert "Action-photo external research return direct-image/identity holds: 8/8" in markdown
    assert "Action-photo external research return ready/download approvals: 0/0" in markdown
    assert "Action-photo external research return fetch/auto-enable: False/False" in markdown
    assert "Action-photo external research return asset/headshot/marker writes: False/False/False" in markdown
    ...
    assert artifact_by_path["adobe_visual_qa_renderer_revision_spec.md"]["run_command"] == ".\\.venv\\Scripts\\python.exe scripts\\build_hsd_adobe_visual_qa_renderer_revision_plan_v1.py"
    assert artifact_by_path["adobe_visual_qa_renderer_revision_spec.csv"]["run_command"] == ".\\.venv\\Scripts\\python.exe scripts\\build_hsd_adobe_visual_qa_renderer_revision_plan_v1.py"
    ...
    assert "future renderer implementation lane" in decision_shortcuts["adobe_visual_qa_renderer_revision_spec.md"]["purpose"]
    ...
    assert artifact_by_path["data/asset_registry/hockey_softball_source_priority_worksheet.md"]["run_command"] == ".\\.venv\\Scripts\\python.exe scripts\\report_hsd_hockey_softball_asset_workflow_readiness_v1.py"
    assert artifact_by_path["data/asset_registry/hockey_softball_source_priority_worksheet.csv"]["run_command"] == ".\\.venv\\Scripts\\python.exe scripts\\report_hsd_hockey_softball_asset_workflow_readiness_v1.py"
    assert artifact_by_path["data/asset_registry/hockey_softball_source_priority_worksheet.json"]["run_command"] == ".\\.venv\\Scripts\\python.exe scripts\\report_hsd_hockey_softball_asset_workflow_readiness_v1.py"
    assert artifact_by_path["data/asset_registry/hockey_softball_source_verification_checklist.md"]["run_command"] == ".\\.venv\\Scripts\\python.exe scripts\\report_hsd_hockey_softball_asset_workflow_readiness_v1.py"
    assert artifact_by_path["data/asset_registry/hockey_softball_source_verification_checklist.csv"]["run_command"] == ".\\.venv\\Scripts\\python.exe scripts\\report_hsd_hockey_softball_asset_workflow_readiness_v1.py"
    assert artifact_by_path["data/asset_registry/hockey_softball_source_verification_checklist.json"]["run_command"] == ".\\.venv\\Scripts\\python.exe scripts\\report_hsd_hockey_softball_asset_workflow_readiness_v1.py"
    assert artifact_by_path["data/asset_registry/hockey_softball_intake_readiness_summary.md"]["run_command"] == ".\\.venv\\Scripts\\python.exe scripts\\report_hsd_hockey_softball_asset_workflow_readiness_v1.py"
    assert artifact_by_path["data/asset_registry/hockey_softball_intake_readiness_summary.csv"]["run_command"] == ".\\.venv\\Scripts\\python.exe scripts\\report_hsd_hockey_softball_asset_workflow_readiness_v1.py"
    assert artifact_by_path["data/asset_registry/hockey_softball_intake_readiness_summary.json"]["run_command"] == ".\\.venv\\Scripts\\python.exe scripts\\report_hsd_hockey_softball_asset_workflow_readiness_v1.py"
    ...
    assert artifact_by_path["data/asset_registry/hockey_softball_asset_review_readiness_board.md"]["run_command"] == ".\\.venv\\Scripts\\python.exe scripts\\report_hsd_hockey_softball_asset_workflow_readiness_v1.py"
    assert artifact_by_path["data/asset_registry/hockey_softball_asset_review_readiness_board.csv"]["run_command"] == ".\\.venv\\Scripts\\python.exe scripts\\report_hsd_hockey_softball_asset_workflow_readiness_v1.py"
    assert artifact_by_path["data/asset_registry/hockey_softball_asset_review_readiness_board.json"]["run_command"] == ".\\.venv\\Scripts\\python.exe scripts\\report_hsd_hockey_softball_asset_workflow_readiness_v1.py"
    assert artifact_by_path["data/asset_registry/hockey_softball_manual_verification_focus.md"]["run_command"] == ".\\.venv\\Scripts\\python.exe scripts\\report_hsd_hockey_softball_asset_workflow_readiness_v1.py"
    assert artifact_by_path["data/asset_registry/hockey_softball_manual_verification_focus.csv"]["run_command"] == ".\\.venv\\Scripts\\python.exe scripts\\report_hsd_hockey_softball_asset_workflow_readiness_v1.py"
    assert artifact_by_path["data/asset_registry/hockey_softball_manual_verification_focus.json"]["run_command"] == ".\\.venv\\Scripts\\python.exe scripts\\report_hsd_hockey_softball_asset_workflow_readiness_v1.py"
    assert artifact_by_path["data/asset_registry/hockey_softball_asset_next_action_cards.md"]["run_command"] == ".\\.venv\\Scripts\\python.exe scripts\\report_hsd_hockey_softball_asset_workflow_readiness_v1.py"
    assert artifact_by_path["data/asset_registry/hockey_softball_asset_next_action_cards.csv"]["run_command"] == ".\\.venv\\Scripts\\python.exe scripts\\report_hsd_hockey_softball_asset_workflow_readiness_v1.py"
    assert artifact_by_path["data/asset_registry/hockey_softball_asset_next_action_cards.json"]["run_command"] == ".\\.venv\\Scripts\\python.exe scripts\\report_hsd_hockey_softball_asset_workflow_readiness_v1.py"
    assert artifact_by_path["data/asset_registry/hockey_softball_quarantine_download_intake.md"]["run_command"] == ".\\.venv\\Scripts\\python.exe scripts\\report_hsd_hockey_softball_asset_workflow_readiness_v1.py"
    ...
    assert artifact_by_path["data/asset_registry/action_photo_candidates/review_only_action_photo_external_research_return_review_v1.md"]["run_command"] == ".\\.venv\\Scripts\\python.exe scripts\\report_hsd_action_photo_external_research_return_review_v1.py"
    assert artifact_by_path["data/asset_registry/action_photo_candidates/review_only_action_photo_external_research_return_review_v1.csv"]["run_command"] == ".\\.venv\\Scripts\\python.exe scripts\\report_hsd_action_photo_external_research_return_review_v1.py"
    assert artifact_by_path["data/asset_registry/action_photo_candidates/review_only_action_photo_external_research_return_review_v1.json"]["run_command"] == ".\\.venv\\Scripts\\python.exe scripts\\report_hsd_action_photo_external_research_return_review_v1.py"
    ...
    assert artifact_by_path["data/asset_registry/action_photo_candidates/review_only_action_photo_manual_first_action_cards_v1.md"]["run_command"] == ".\\.venv\\Scripts\\python.exe scripts\\report_hsd_action_photo_manual_research_bridge_v1.py"
    assert artifact_by_path["data/asset_registry/action_photo_candidates/review_only_action_photo_manual_first_action_cards_v1.csv"]["run_command"] == ".\\.venv\\Scripts\\python.exe scripts\\report_hsd_action_photo_manual_research_bridge_v1.py"
    assert artifact_by_path["data/asset_registry/action_photo_candidates/review_only_action_photo_manual_first_action_cards_v1.json"]["run_command"] == ".\\.venv\\Scripts\\python.exe scripts\\report_hsd_action_photo_manual_research_bridge_v1.py"
    ...
    assert artifact_by_path["data/asset_registry/action_photo_candidates/review_only_action_photo_quarantine_preflight_v1.md"]["run_command"] == ".\\.venv\\Scripts\\python.exe scripts\\report_hsd_action_photo_quarantine_preflight_v1.py"
    assert artifact_by_path["data/asset_registry/action_photo_candidates/review_only_action_photo_quarantine_preflight_v1.csv"]["run_command"] == ".\\.venv\\Scripts\\python.exe scripts\\report_hsd_action_photo_quarantine_preflight_v1.py"
    assert artifact_by_path["data/asset_registry/action_photo_candidates/review_only_action_photo_quarantine_preflight_v1.json"]["run_command"] == ".\\.venv\\Scripts\\python.exe scripts\\report_hsd_action_photo_quarantine_preflight_v1.py"
...
def test_command_center_surfaces_release_readiness_evidence_rollup(tmp_path, monkeypatch) -> None:
    ...
    assert panel["workflow_missing_durable_lanes"] == 2
...
def test_local_runner_collects_daily_command_center_artifacts() -> None:
    ...
    assert "data/asset_registry/action_photo_candidates/review_only_action_photo_external_research_return_review_v1.md" in runner
    assert "data/asset_registry/action_photo_candidates/review_only_action_photo_external_research_return_review_v1.csv" in runner
    assert "data/asset_registry/action_photo_candidates/review_only_action_photo_external_research_return_review_v1.json" in runner
    ...
    assert "data/asset_registry/action_photo_candidates/review_only_action_photo_manual_first_action_cards_v1.md" in runner
    assert "data/asset_registry/action_photo_candidates/review_only_action_photo_manual_first_action_cards_v1.csv" in runner
    assert "data/asset_registry/action_photo_candidates/review_only_action_photo_manual_first_action_cards_v1.json" in runner
    ...
    assert "adobe_visual_qa_renderer_revision_spec.md" in runner
    assert "adobe_visual_qa_renderer_revision_spec.csv" in runner
    assert "adobe_visual_qa_renderer_revision_spec.json" in runner
