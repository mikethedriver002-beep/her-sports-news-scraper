...
def test_renderer_version_is_phase6i():
    ...
    assert module.VERSION == "v4.4-phase6i-final-score-template-polish"
...
def test_live_policy_enables_final_score_polish_release_review():
    ...
    assert data["version"] == "v1.2-phase6i-final-score-template-polish-policy"
    assert data["phase6i_final_score_polish_release_review"] is True
...
def test_validator_exposes_final_score_polish_fields():
    ...
    assert module.VERSION == "v1.2-phase6i-final-score-polish-live-gate"
