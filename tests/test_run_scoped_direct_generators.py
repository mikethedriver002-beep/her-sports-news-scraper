...
def test_direct_run_generators_are_wired_to_shared_run_io() -> None:
    required = {
        ...
        "scripts/build_hsd_wnba_graphics_visual_rubric_v1.py": ["from hsd_run_io import", 'OUT_DIR_REL = Path("wnba_graphics_visual_rubric_v1")', "write_json(packet_dir / MANIFEST_NAME"],
